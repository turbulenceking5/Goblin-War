...
- Combat drains both by a flat amount regardless of outcome (`COMBAT_HUNGER_GAIN` 8, `COMBAT_THIRST_GAIN` 10, applied in `endCombat` right after `combat = null`) — victory, defeat, or fleeing are all real exertion.
