...
```js
{
  ...
  distanceMiles, distanceHours, // deliver_* only; giver-to-target travel distance at accept time
                                 // (see computeDistanceBetween below) — undefined for kill_*
  reward: { gold, xp },
